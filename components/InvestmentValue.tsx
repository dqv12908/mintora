...
function SafetyFirstIllustration() {
  return (
    <svg viewBox="0 0 320 160" fill="none" className="w-full h-36 md:h-40">
      ...
      <path d="M160,18 L205,35 C208,36 210,39 210,42 L210,72 C210,95 188,115 160,125 C132,115 110,95 110,72 L110,42 C110,39 112,36 115,35 Z" fill="url(#sf-shield)" stroke="#00f0ff" strokeWidth="2" opacity="0.9" />
      <path d="M160,28 L198,42 L198,72 C198,90 181,107 160,115 C139,107 122,90 122,72 L122,42 Z" fill="none" stroke="#00f0ff" strokeWidth="0.5" opacity="0.3" />
...
const illustrations = [
  <IntrinsicValueIllustration key="iv" />,
  <PredictabilityIllustration key="pred" />,
  <SafetyFirstIllustration key="sf" />,
  <GovernancePowerIllustration key="gv" />,
];
    ...
    <section className="section-padding relative">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {t.investment.benefits.map((benefit, i) => (
            <TiltCard
              key={i}
              title={benefit.title}
